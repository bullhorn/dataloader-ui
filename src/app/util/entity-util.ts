...
export class EntityUtil {
  ...
  static get ENTITY_NAMES(): string[] {
    return [
      ...
      EntityTypes.PlacementCertification,
      ...
      EntityTypes.PersonCustomObjectInstance26,
      EntityTypes.PersonCustomObjectInstance27,
      EntityTypes.PersonCustomObjectInstance28,
      EntityTypes.PersonCustomObjectInstance29,
      EntityTypes.PersonCustomObjectInstance30,
      EntityTypes.PersonCustomObjectInstance31,
      EntityTypes.PersonCustomObjectInstance32,
      EntityTypes.PersonCustomObjectInstance33,
      EntityTypes.PersonCustomObjectInstance34,
      EntityTypes.PersonCustomObjectInstance35,
  ...
  static get ENTITY_ICONS(): any {
    return {
      ...
      [EntityTypes.CandidateTaxInfo]: 'rate',
      ...
      [EntityTypes.PlacementCertification]: 'credential',
