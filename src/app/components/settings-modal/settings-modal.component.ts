    ...
    this.zone.run(() => {
      if (loginResponse.startsWith('Login Successful')) {
        ...
        this.modalService.open(InfoModalComponent, {
          title: loginResponse,
          message:
            'Either your username/password or clientId/clientSecret is invalid. ' +
    ...
    const meta: any = {
      ...
      fields: [
        ...
        },
        {
          ...
          sortOrder: 21,
          interactions: [{ event: 'change', script: SettingsModalComponent.onDataCenterChange }],
        },
        {
          name: 'authorizeUrl',
          type: 'text',
        ...
        },
        {
          ...
          required: true,
          description:
            'Used to separate individual values in a single field when that field supports multiple values. ' +
        ...
        },
        {
          ...
          required: true,
          description:
            'If Yes then all To-Many association cells that are empty will remove any existing associations. ' +
        ...
        },
        {
          ...
          required: true,
          description:
            'If Yes then updating of existing duplicate records will be skipped. New records will be added but ' +
        ...
        },
        {
          ...
          required: true,
          description:
            'If Yes then wildcards (*) can be used within a cell to search for multiple associations ' +
        ...
        },
        {
          ...
          required: true,
          description:
            'If Yes then CSV files will be read in using the ISO-8859-1 (single-byte) encoding. ' +
        ...
        },
        {
          ...
          required: true,
          description:
            'If Yes then Rest Form Triggers will be executed on insert/update calls. ' +
        ...
        },
        {
          ...
          required: true,
          description:
            'Makes loading data much faster by making as few rest calls as possible. Stores data client ' +
